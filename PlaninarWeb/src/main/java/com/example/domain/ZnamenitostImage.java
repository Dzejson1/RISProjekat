...
public class ZnamenitostImage implements Serializable {
	...
	private boolean potrebnoZakPom;
	

	public boolean isPotrebnoZakPom() {
		return potrebnoZakPom;
	}

	public void setPotrebnoZakPom(boolean potrebnoZakPom) {
		this.potrebnoZakPom = potrebnoZakPom;
	}
